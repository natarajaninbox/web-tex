...
$Q_{\text{free}} = \{X \in \mathbb{Q} \mid X \cap \left(\mathbb{Q} \cap \left(\bigcup_{i} O_i\right)\right) = \emptyset\}$
...
\begin{figure}
    \centering
    \includegraphics[scale=20]{media/turtlebot3_burger_components.png}
    \caption{Caption}
